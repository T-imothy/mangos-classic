...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_ADAPTIVE_LOAD_PER_MAP_SLOW_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_PER_MAP_RECOVER_MS,
    CONFIG_UINT32_ADAPTIVE_LOAD_PER_MAP_MIN_VISIBILITY_PERCENT,
    CONFIG_UINT32_ADAPTIVE_LOAD_PER_MAP_STEP_PERCENT,
    ...
    CONFIG_UINT32_MOVEMENT_BROADCAST_OVERLOAD_WAIT_MS,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_ADAPTIVE_LOAD_PER_MAP_ENABLED,
    CONFIG_BOOL_MOVEMENT_COMPRESSION_ENABLED,
    CONFIG_BOOL_MOVEMENT_BROADCAST_COALESCE,
