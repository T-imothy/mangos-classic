...
1. Build with the existing Build-Local-Classic.cmd launcher.
2. Before starting the new binary with transmog enabled, run ONLY
   sql/custom/transmog/INSTALL-CLASSIC.sql. It selects mangos_classic and
   character_classic explicitly, installs NPC 190010 in Stormwind/Orgrimmar, and
...
5. Install addons/1.12/Transmog in the client's Interface/AddOns directory.
