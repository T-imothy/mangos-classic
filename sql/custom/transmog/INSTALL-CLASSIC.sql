-- ManTech Transmog: CLASSIC ONLY. Run once before enabling transmog.conf.
-- Safe to repeat: preserves existing appearances and existing NPC rows.
USE `mangos_classic`;
START TRANSACTION;
SET @Entry := 190010;
